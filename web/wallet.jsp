                        ...
                        <div class="card mb-3" style="border-radius: .5rem;height:100%">
                            <div class="row g-0" style="height:100%">
                                <div class="col-md-4 gradient-custom text-center text-white"
                                    ...
                                    <h5>Số dư</h5>
                                    <p><fmt:formatNumber value="${sessionScope.account.amount}" type="number" groupingUsed="true"/>đ</p>
                                    <i class="far fa-edit mb-5"></i>
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body p-4">
                                        <h6>Nạp tiền vào ví</h6>
                                        <hr class="mt-0 mb-4">
                                        <div class="row pt-1">
                                            <form action="wallet" method="post">
                                                <div class="col-12 mb-3">
                                                    <h4>Nhập số tiền muốn nạp</h4><br/>
                                                    <input type="number" name="amountAdd">
                                                </div>
                                                <div class="col-6 col-lg-4 col-xl-2">
                                                    <div class="btn-wrap">
                                                        <button type="submit" class="btn btn-primary btn-round">Nạp</button>
                                                    </div><!-- End .btn-wrap -->
                                                </div>
                                            </form>
