                                                ...
                                                <tbody>
                                                    <c:forEach items="${requestScope.listuser}" var="listuser">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>${listuser.createdDate}</td>
                                                            <td>${listuser.amount}</td>
                                                            <td>${listuser.role}</td>
                                                            <td>
                                                                <div class="form-button-action">
                                                                    <button
                                                                        ...
                                                                        >
                                                                        <a href="editUser?id=${listuser.userId}"><i class="fa fa-edit"></i></a>
                                                                    </button>
                                                                    <button
                                                                        type="button"
                                                                        data-bs-toggle="tooltip"
                                                                        ...
                                                                        >
                                                                        <a href="javascript:void(0);" onclick="doDelete('${listuser.userId}')"><i class="fa fa-times"></i></a>
                                                                    </button>
                                                                </div>
                                                            </td>
                                                            </a>
