...
<html lang="en">
    ...
    <body>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <ul class="compare-products">
                                            <li class="compare-product">
                                                <h4 class="compare-product-title"><a id="dang-nhap1" href="">Đăng nhập</a></h4>
                                            </li>
                                            <li class="compare-product">
                    ...
                    <div class="checkout">
                        <div class="container">
                            ...
                            <form action="checkout" method="post">
                                <div class="row">
                                    <div class="col-lg-9">
                                        <input type="hidden" id="dang-nhap3" name="direct" value="">
                                        ...
                                        <label>Ghi chú</label>
                                        <textarea class="form-control" name="note" cols="30" rows="4" placeholder="Ghi chú, VD. Ghi chú đặc biệt cho giao hàng"></textarea>

                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" name="khac" value="ok" class="custom-control-input" id="checkout-diff-address" onchange="toggleShippingInfo()">
                                            <label class="custom-control-label" for="checkout-diff-address">Thông tin giao hàng khác?</label>
                                        </div><!-- End .custom-checkbox -->

                                        <div id="different-shipping-info" style="display: none;">
                                            <label>Họ và tên</label>
                                            ...
                                            <label>Ghi chú</label>
                                            <textarea class="form-control" name="shippingNote" cols="30" rows="4" placeholder="Ghi chú, VD. Ghi chú đặc biệt cho giao hàng"></textarea>
                                        </div>
                                    </div><!-- End .col-lg-9 -->
                                    <aside class="col-lg-3">
                                        <div class="summary">
                                            ...
                                            <table class="table table-summary">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${requestScope.cart.items}" var="items">
                                                        <tr>
                                                            ...
                                                            <td>${items.quantity}x<fmt:formatNumber value="${items.price}" type="number" groupingUsed="true"/>đ</td>
                                                        </tr>
                                                    </c:forEach>
                                                <input type="text" hidden name="shipping" value="${requestScope.shipping}">
                                                ...
                                                <tr>
                                                    <td>Giao hàng:</td>
                                                    <c:if test="${requestScope.shipping == 50000}">
                                                        <td>Tiết kiệm<br/><fmt:formatNumber value="50000" type="number" groupingUsed="true"/>đ</td>
                                                        </c:if>
                                                        <c:if test="${requestScope.shipping == 100000}">
                                                        <td>Nhanh<br/><fmt:formatNumber value="100000" type="number" groupingUsed="true"/>đ</td>
                                                        </c:if>
                                                </tr>
                                                <tr class="summary-total">
                                                    <td>Thành tiền:</td>
                                                    <td><fmt:formatNumber value="${requestScope.cart.getTotalWithShip()}" type="number" groupingUsed="true"/>đ</td>
                                            ...
                                            <div class="accordion-summary" id="accordion-payment">
                                                <div class="card">
                                                    <input type="text" hidden id="payment-method" name="paymentMethod" value="0">
                                                    <div class="card-header" id="heading-1">
                                                        <h2 class="card-title">
                                                            <a role="button" data-toggle="collapse" href="#collapse-1" aria-expanded="true" aria-controls="collapse-1" onclick="setPaymentMethod('wallet')">
                                                                Thanh toán bằng ví
                                                            </a>
                                                        </h2>
                                                    </div><!-- End .card-header -->
                                                    <div id="collapse-1" class="collapse show" aria-labelledby="heading-1" data-parent="#accordion-payment">
                                                        <div class="card-body">
                                                            <c:if test="${sessionScope.account==null}">
                                                                Vui lòng <a id="dang-nhap2" href="">đăng nhập</a>
                                                            </c:if>
                                                            <c:if test="${sessionScope.account!=null}">
                                                                Số dư: <fmt:formatNumber value="${sessionScope.account.amount}" type="number" groupingUsed="true"/>đ
                                                            </c:if>
                                                ...
                                                <div class="card">
                                                    <div class="card-header" id="heading-2">
                                                        <h2 class="card-title">
                                                            <a class="collapsed" role="button" data-toggle="collapse" href="#collapse-2" aria-expanded="false" aria-controls="collapse-2" onclick="setPaymentMethod('bank')">
                                                ...
                                                <div class="card">
                                                    <div class="card-header" id="heading-3">
                                                        <h2 class="card-title">
                                                            <a class="collapsed" role="button" data-toggle="collapse" href="#collapse-3" aria-expanded="false" aria-controls="collapse-3" onclick="setPaymentMethod('cod')">
                                                                Thanh toán khi nhận hàng
                                                            </a>
                                                        </h2>
                                                    </div><!-- End .card-header -->
                                                    <div id="collapse-3" class="collapse" aria-labelledby="heading-3" data-parent="#accordion-payment">
                                                        <div class="card-body">Quý khách được phép kiểm tra hàng rồi mới thanh toán. 
                                                        </div><!-- End .card-body -->
                                                    </div><!-- End .collapse -->
                                                </div><!-- End .card -->
                                            </div><!-- End .accordion -->
        ...
        <script>
                                                                ...
                                                                var startIndex = currentURL.indexOf('checkout');
                                                                var desiredURLPart = currentURL.substring(startIndex);
                                                                desiredURLPart = 'signin?direct=' + desiredURLPart;
                                                                document.addEventListener('DOMContentLoaded', function () {
                                                                    var dangNhapLink1 = document.getElementById('dang-nhap1');
                                                                    if (dangNhapLink1) {
                                                                        dangNhapLink1.href = desiredURLPart;
                                                                    }
                                                                    var dangNhapLink2 = document.getElementById('dang-nhap2');
                                                                    if (dangNhapLink2) {
                                                                        dangNhapLink2.href = desiredURLPart;
                                                                    }
                                                                    var dangNhapLink3 = document.getElementById('dang-nhap3');
                                                                    if (dangNhapLink3) {
                                                                        dangNhapLink3.value = desiredURLPart;
                                                                    }
                                                                });
        </script>
    </body>
