                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">Chọn phương án thêm sản phẩm</div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row tab">
                                            ...
                                            <c:set value="${requestScope.proid}" var="pid"></c:set>
                                                <h2>Bạn muốn thêm phiên bản khác của sản phẩm này không?</h2>

                                                <div class="col-md-6 col-lg-6">
                                                    <div class="form-group form-inline">
                                                        <div class="card-action">
                                                            <button class="btn btn-success"><a href="addprodetail?id=${pid}" style="color: #fff">Có</a></button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="card-action">
                                                        <button class="btn btn-success"><a href="listproadmin?id=${pid}" style="color: #fff">Không</a></button>
                                                    </div>
                                                </div>
                                            </div>
