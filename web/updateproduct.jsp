                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <c:set value="${requestScope.pro}" var="lp"></c:set>
                                            <form action="updateproadmin" method="post">
                                                <div class="row tab">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            ...
                                                            <c:forEach items="${requestScope.listcat}" var="lc">
                                                                <option ${lc.categoryId==lp.categoryId?'selected':''} value="${lc.categoryId}">${lc.categoryName}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <button type="button" class="btn btn-primary" style="margin-top: 20px"><a href="updateimage?id=${lp.productId}" style="color: #fff">Chỉnh sửa ảnh sản phẩm</a></button>
                                                    </div>
                                                ...
                                                <div class="col-md-6 col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="comment" rows="5" name="descrip" >${lp.description}
                                                        </textarea>
                                                        <script>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            ...
                                                            name="warranty"
                                                            >
                                                            <option value="6 tháng" ${'6 tháng'==lp.warrantyPeriod?'selected':''}>6 tháng</option>
                                                            <option value="8 tháng" ${'8 tháng'==lp.warrantyPeriod?'selected':''}>8 tháng</option>
                                                            <option value="10 tháng" ${'10 tháng'==lp.warrantyPeriod?'selected':''}>10 tháng</option>
                                                            <option value="12 tháng" ${'12 tháng'==lp.warrantyPeriod?'selected':''}>12 tháng</option>
                                                            <option value="2 năm" ${'2 năm'==lp.warrantyPeriod?'selected':''}>2 năm</option>
                                                            <option value="3 năm" ${'3 năm'==lp.warrantyPeriod?'selected':''}>3 năm</option>
                                                        </select>
                                                    </div>
