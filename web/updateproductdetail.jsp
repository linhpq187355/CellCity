                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <c:set value="${requestScope.prode}" var="prode"></c:set>
                                    <div class="card-body">
                                        <form action="updateprodetail" method="post">
                                            <div class="row tab">

                                                <div class="col-md-6 col-lg-6">
                                                    <input type="text" name="proid" value="${requestScope.pro.productId}" hidden>
                                                    <input type="text" name="id" value="${prode.id}" hidden>
                                                ...
                                                <div class="col-md-6 col-lg-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select
                                                            ...
                                                            >
                                                            <c:forEach items="${requestScope.color}" var="lc">
                                                                <option ${prode.colorId==lc.id?'selected':''} value="${lc.id}">${lc.name}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
