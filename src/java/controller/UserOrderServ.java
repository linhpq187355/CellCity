 ...
 * @author ASUS
 */
@WebServlet(name="UserOrderServ", urlPatterns={"/userorder"})
public class UserOrderServ extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UserOrderServ</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UserOrderServ at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<Order> listorder = od.getOrderByUser(a.getUserId());
        List<List<OrderDetail>> listOrderDetail = new ArrayList<>();
        for(int i=0;i<listorder.size();i++){
            listOrderDetail.add(odd.getAllByOId(listorder.get(i).getId()));
        }
        ...
        request.setAttribute("listallprodetail", listallprodetail);
