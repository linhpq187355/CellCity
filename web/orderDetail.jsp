                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h5>Họ và tên: ${requestScope.order.shipping_name}</h5>
                                                <h5>SĐT: ${requestScope.order.shipping_phone}</h5>
                                                <h5>Email: ${requestScope.order.shipping_email}</h5>
                                                <h5>Địa chỉ: ${requestScope.order.shipAddress}</h5>
                                            </div>
                                            <div class="col-md-6">
                                                <h5>Tổng đơn giá: ${requestScope.order.totalAmount}</h5>
                                                <h5>Ngày đặt hàng: ${requestScope.order.orderDate}</h5>
                                                <h5>Phương thức thanh toán: ${requestScope.order.payment}</h5>
                                                <h5>Loại ship: 
                                                    <c:if test="${requestScope.order.shippingFee==50000}">
                                                        Tiết kiệm
                                                    </c:if>
                                                    <c:if test="${requestScope.order.shippingFee==100000}">
                                                        Nhanh
                                                    </c:if>
                                                </h5>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach items="${requestScope.listodetail}" var="listodetails">
                                                        <tr>

                                                            <c:forEach items="${requestScope.listallprodetail}" var="listallprodetail">
                                                                <c:if test="${listallprodetail.id == listodetails.productDetailId}">
                                                                        ...
                                                                        <c:if test="${listallproduct.productId == listallprodetail.productID}">
                                                                            <c:forEach items="${requestScope.colorlist}" var="colorlist">
                                                                                <c:if test="${colorlist.id == listallprodetail.colorId}">
                                                                                    <td>${listallproduct.name} ${listallprodetail.ram}GB ${listallprodetail.rom}GB ${colorlist.name}
                                                                                    ...
                                                                                    <td>${listodetails.quantity}</td>
                                                                                    <td>${listodetails.price}</td>
                                                                                </c:if>
                                                                            </c:forEach>
                                                                        </c:if>
                                                                    </c:forEach>
